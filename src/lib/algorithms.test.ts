...
const baseParams: ProcessingParams = {
  fleetPool: [{ id: 'v1', type: '4-wheel', name: 'Truck', capacityCBM: 20, fuelConsumption: 0.12, fixedCost: 0, color: '#10B981', fuelPrice: 35, departureTime: '08:00' }],
  avgSpeed: 50,
...
describe('checkRouteFeasible', () => {
  ...
  it('returns false when route volume exceeds max capacity', () => {
    const heavyParams: ProcessingParams = {
      ...baseParams,
      fleetPool: [{ id: 'v1', type: '4-wheel', name: 'Truck', capacityCBM: 5, fuelConsumption: 0.12, fixedCost: 0, color: '#10B981', fuelPrice: 35, departureTime: '08:00' }],
    };
