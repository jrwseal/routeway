      ...
      <div className="bg-slate-50 rounded-2xl shadow-xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden animate-fade-in">
        ...
        <div className="bg-white px-4 sm:px-6 py-4 border-b border-slate-200 flex justify-between items-center gap-2">
          <h2 className="text-lg sm:text-2xl font-bold text-fleet-navy flex items-center">
            <span className="text-xl sm:text-2xl mr-2">⚙️</span> ตั้งค่ากองรถ (Dynamic Fleet Configuration)
          </h2>
        ...
        {/* Footer */}
        <div className="bg-white px-4 sm:px-6 py-4 border-t border-slate-200 flex flex-col-reverse sm:flex-row justify-end items-stretch sm:items-center gap-3 sm:gap-4">
          <button
            onClick={handleStandardConfig}
            className="flex items-center justify-center px-4 py-2 bg-slate-200 text-slate-700 hover:bg-slate-300 rounded-md font-bold text-sm transition-colors"
          >
          ...
          <button
            onClick={handleSave}
            className="flex items-center justify-center px-6 py-2 bg-fleet-navy text-white hover:bg-blue-800 rounded-md font-bold text-sm transition-colors shadow-md"
          >
